...
import { GALLERY, TESTIMONIALS } from "../config";
      ...
      <section className="s28-section">
        <div className="s28-container s28-intro">
          <div>
            ...
            <p>
              Studios 28 is a boutique photography studio in Bangalore founded on a
              simple idea: your story deserves imagery that lasts. From intimate
              portraits to grand weddings and considered brand campaigns, we
              approach every shoot with care, craft, and a quiet eye for detail.
            </p>
            <p>
              We work closely with each client — from first call to final gallery —
              so the pictures feel like you, not a template.
            </p>
            <div style={{ display: "flex", gap: 12, marginTop: 8, flexWrap: "wrap" }}>
              <Link to="/about" className="s28-btn s28-btn-outline">Our Story</Link>
      ...
      <section className="s28-section" style={{ background: "var(--s28-cream)" }}>
        <div className="s28-container">
          ...
          <div style={{ textAlign: "center", marginTop: 40 }}>
            <Link to="/portfolio" className="s28-btn s28-btn-outline">View Full Portfolio</Link>
          </div>
        </div>
      </section>
