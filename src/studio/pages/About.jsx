    ...
    <>
      ...
      <section className="s28-section">
        <div className="s28-container s28-about-hero">
          ...
          <div>
            ...
            <p>
              Founded in Bangalore, Studios 28 began as a small passion project between
              friends who loved film cameras and long shoots. Today, we're a full-service
              studio serving couples, families, and brands across Karnataka and beyond.
            </p>
            <p>
              Our approach is calm, considered, and collaborative — because the best
              pictures happen when everyone feels at ease.
            </p>
      ...
      <section className="s28-section" style={{ background: "var(--s28-cream)" }}>
        <div className="s28-container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24, textAlign: "center", color: "var(--s28-muted)", fontFamily: "var(--s28-serif)", fontSize: "1.4rem" }}>
            <div>WedMeGood</div>
      ...
      <section className="s28-section">
        <div className="s28-container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
            {BTS.map((id) => (
              <div key={id} className="s28-tile" style={{ aspectRatio: "3/4" }}>
                <img src={`https://images.unsplash.com/photo-${id}?auto=format&fit=crop&w=800&q=70`} alt="Behind the scenes" loading="lazy" />
              </div>
            ))}
          </div>
        </div>
