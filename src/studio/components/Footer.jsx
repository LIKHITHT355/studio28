        ...
        <div className="s28-footer-grid">
          <div>
            ...
            <p style={{ color: "#a29a90", maxWidth: 320 }}>
              A Bangalore-based photography studio capturing weddings, portraits, and brand stories
            ...
            <div className="s28-socials">
              ...
              >
                <Icon>
                  <path d="M21 11.5a8.5 8.5 0 1 1-16.06-3.94L3 21l6.44-1.94A8.5 8.5 0 0 0 21 11.5z" />
                </Icon>
              </a>
            </div>
          </div>
